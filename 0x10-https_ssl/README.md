...
![HTTP Vs HTTPS](https://www.instantssl.com/images/http-vs-https.png)
...
![HTTPS Browsers](https://www.instantssl.com/images/https-browsers.png)
...
How does HTTP work? How is  _HTTPS_  different from HTTP? This tutorial will teach you about SSL, HTTP and HTTPS.
...
The procedure for exchanging public keys using SSL Certificate to enable HTTPS, SSL and TLS is called Public Key Infrastructure (PKI).# What is HTTPS?
